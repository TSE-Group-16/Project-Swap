...
public class groundCheck : MonoBehaviour
{
    ...
    public bool checkForGround()
    {
        ...
        if (PC.hasLeg)
        {
            ...
            leftCenterHit = Physics.Raycast(new Vector3(this.transform.position.x - bounds.extents.x * this.transform.right.x * 0.6f, PC.getCurLeg().transform.position.y, this.transform.position.z - bounds.extents.z * this.transform.right.z * 0.6f), -this.transform.up, out rayLeftCenter, 0.15f);
            rightCenterHit = Physics.Raycast(new Vector3(this.transform.position.x + bounds.extents.x * this.transform.right.x * 0.6f, PC.getCurLeg().transform.position.y, this.transform.position.z + bounds.extents.z * this.transform.right.z * 0.6f), -this.transform.up, out rayRightCenter, 0.15f);
            frontLeftHit = Physics.Raycast(new Vector3(this.transform.position.x + bounds.extents.x * (-this.transform.right.x + this.transform.forward.x) * 0.6f, PC.getCurLeg().transform.position.y, this.transform.position.z + this.bounds.extents.z * (this.transform.right.z + -this.transform.forward.z) * 0.6f), -this.transform.up, out rayFrontLeft, 0.15f);
            frontRightHit = Physics.Raycast(new Vector3(this.transform.position.x + bounds.extents.x * (this.transform.right.x + this.transform.forward.x) * 0.6f, PC.getCurLeg().transform.position.y, this.transform.position.z + this.bounds.extents.z * (this.transform.right.z + this.transform.forward.z) * 0.6f), -this.transform.up, out rayFrontRight, 0.15f);
            backLeftHit = Physics.Raycast(new Vector3(this.transform.position.x - bounds.extents.x * (this.transform.right.x + this.transform.forward.x) * 0.6f, PC.getCurLeg().transform.position.y, this.transform.position.z - this.bounds.extents.z * (this.transform.right.z + -this.transform.forward.z) * 0.6f), -this.transform.up, out rayBackLeft, 0.15f);
            backRightHit = Physics.Raycast(new Vector3(this.transform.position.x - bounds.extents.x * (-this.transform.right.x + this.transform.forward.x) * 0.6f, PC.getCurLeg().transform.position.y, this.transform.position.z - this.bounds.extents.z * (-this.transform.right.z + this.transform.forward.z) * 0.6f), -this.transform.up, out rayBackRight, 0.15f);
        ...
        else
        {
            ...
            Debug.Log(bounds);
            centerHit = Physics.Raycast(new Vector3(this.transform.position.x, this.transform.position.y, this.transform.position.z), -this.transform.up, out rayCenter, 0.15f);
            leftCenterHit = Physics.Raycast(new Vector3(this.transform.position.x - bounds.extents.x * this.transform.right.x * 0.6f, this.transform.position.y, this.transform.position.z - bounds.extents.z * this.transform.right.z * 0.6f), -this.transform.up, out rayLeftCenter, 0.15f);
            rightCenterHit = Physics.Raycast(new Vector3(this.transform.position.x + bounds.extents.x * this.transform.right.x * 0.6f, this.transform.position.y, this.transform.position.z + bounds.extents.z * this.transform.right.z * 0.6f), -this.transform.up, out rayRightCenter, 0.15f);
            frontLeftHit = Physics.Raycast(new Vector3(this.transform.position.x + bounds.extents.x * (-this.transform.right.x + this.transform.forward.x) * 0.6f, this.transform.position.y, this.transform.position.z + this.bounds.extents.z * (this.transform.right.z + -this.transform.forward.z) * 0.6f), -this.transform.up, out rayFrontLeft, 0.15f);
            frontRightHit = Physics.Raycast(new Vector3(this.transform.position.x + bounds.extents.x * (this.transform.right.x + this.transform.forward.x) * 0.6f, this.transform.position.y, this.transform.position.z + this.bounds.extents.z * (this.transform.right.z + this.transform.forward.z) * 0.6f), -this.transform.up, out rayFrontRight, 0.15f);
            backLeftHit = Physics.Raycast(new Vector3(this.transform.position.x - bounds.extents.x * (this.transform.right.x + this.transform.forward.x) * 0.6f, this.transform.position.y, this.transform.position.z - this.bounds.extents.z * (this.transform.right.z + -this.transform.forward.z) * 0.6f), -this.transform.up, out rayBackLeft, 0.15f);
            backRightHit = Physics.Raycast(new Vector3(this.transform.position.x - bounds.extents.x * (-this.transform.right.x + this.transform.forward.x) * 0.6f, this.transform.position.y, this.transform.position.z + this.bounds.extents.z * (-this.transform.right.z + this.transform.forward.z) * 0.6f), -this.transform.up, out rayBackRight, 0.15f);
